...
\begin{figure}[h]
    ...
    \begin{subfigure}[h]{0.48\textwidth}
        ...
        \includegraphics[width=\textwidth, trim={0 120 120 40}, clip]{images/sito1(1).jpg}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[h]{0.40\textwidth}
        \centering
        %\vspace{0pt}% allinea in alto
        \includegraphics[width=\textwidth]{images/Jetson+Kinect.jpg}
        \caption{Jetson Nano and Azure Kinect used in the Site 1 setup}
    \end{subfigure}\hfill
    \begin{subfigure}[h]{0.40\textwidth}
        \centering
        %\vspace{0pt}% allinea in alto
        \includegraphics[width=\textwidth]{images/Kinect_on_site1.jpg}
