...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        ...
        \caption{RGB image of dough ball}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{"images/depth.png"}
        \caption{Depth map of dough ball}
    \end{subfigure}
    \caption{Representative RGB and depth inputs for the dough-ball sample used in the qualitative comparison.}
    \label{fig:RGB_Depth}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.67\textwidth}
        ...
        \caption{Rotated convex-hull reconstruction}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.67\textwidth}
        ...
        \caption{Rotated alpha-shape reconstruction}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.67\textwidth}
        \centering
        \includegraphics[width=\linewidth]{"images/gap.png"}
        \caption{Depth-gap reconstruction}
    \end{subfigure}
    \caption{Representative qualitative comparison of the three volume estimators on the same dough-ball sample.}
    \label{fig:volume_reconstruction_example}
\end{figure}
