...
% Margini: gestiti da geometry (vedi model/packages.tex)
% (Disattivata l'impostazione manuale di \textwidth/\textheight e dei *sidemargin* per evitare conflitti.)
%\textwidth       =  14.50 cm
%\textheight      =  23.10 cm
%\topmargin       =   0.00 cm
%\oddsidemargin   =   1.46 cm
...
% stile per i titoli
% Nota: \sffamily rende i titoli sans-serif (non Times). Rimuovendolo i titoli seguono il font principale.
